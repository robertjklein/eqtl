...
MYLIBS   = -lsquid -lm -lgsl -lgslcblas
MYLIBDIR = -L/sc/orga/projects/kleinr08a/lib
MYINCDIR = -I/sc/orga/projects/kleinr08a/include


PROGS = eqtl test

OBJS  = nonparam.o regress.o eqtlio.o
HDRS  = nonparam.h regress.h eqtlio.h
